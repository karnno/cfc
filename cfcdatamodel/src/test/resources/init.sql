...
ID BIGINT default CFC_PLAYERS_SEQ.NEXTVAL primary key,
NAME varchar(255),
TAGLINE varchar(255)
);
...
ID BIGINT default CFC_GAMES_SEQ.NEXTVAL primary key,
GAME_DATE date,
GAME_STATUS varchar(25)
);

CREATE TABLE IF NOT EXISTS DECKS(
ID BIGINT default CFC_DECKS_SEQ.NEXTVAL primary key,
NAME varchar(255),
PLAYER_ID BIGINT,
...
ID BIGINT default CFC_CARDS_SEQ.NEXTVAL primary key,
NAME varchar(255),
ENERGY INT,
MOTIVATION INT,
CREDIBILITY INT,
...
FOREIGN KEY(DECK_ID1) REFERENCES DECKS(ID),
FOREIGN KEY(DECK_ID2) REFERENCES DECKS(ID)
