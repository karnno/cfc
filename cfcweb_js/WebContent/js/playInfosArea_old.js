...
function PlayInfosArea(gameGfxCtx_playerInfo, playerInfo, playerInfoTextId) {
...
PlayInfosArea.prototype.render= function(){
	...
	this.gameGfxCtx_playerInfo.clearRect(0,0, 400, 100);
...
PlayInfosArea.prototype.setPlayerInfo= function(){
	...
	$('#' +this.playerInfoTextId).text(JSON.stringify(this.playerInfo));
